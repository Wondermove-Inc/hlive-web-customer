//!   appEnv in ('local','dev','stage','production')
const appEnv = 'dev';
const appType = 'customer';
const wsConnectionInterval = 1000;
const appName = 'myHyundai';

//!   api server_url
const devServer = 'http://dev.wondermove.kr/viva/apis';
const stageServer = 'http://stg.wondermove.kr/viva'; //! TODO
const prodServer = 'https://myhyundai.hyundai-europe.com/api';
const domImageServer = 'http://wondermove.kr:8080'; //! TODO
const webRTCDevServer = 'https://webrtcwondermove.germanywestcentral.cloudapp.azure.com:443';
const webRTCProdServer = 'https://myhyundai.hyundai-europe.com:443/peerjs';
const webRTCDevUri = 'webrtcwondermove.germanywestcentral.cloudapp.azure.com';
const webRTCProdUri = 'myhyundai.hyundai-europe.com';
const webRTCDevPath = '/peerjs';
const webRTCProdPath = '/peerjs/peerjs';
const webRTCDevPort = 443;
const webRTCProdPort = 443;
const sentryDSN = 'https://3b8914533873464e8a32eb3518ca3a91@o4504195150905344.ingest.sentry.io/4504195169124352';
const sentrySampleRate = 1.0;
const sentryDev = 'dev';
const sentryStage = 'stage';
const sentryProd = 'production';

const rdDev = 'development';
const rdProd = 'production';

const webSocket = 'http://socket.wondermove.kr/viva'; //! TODO 확인
const stageWebSocket = 'https://myhyundai-stg.hyundai-europe.com/';
const prodWebSocket = 'https://myhyundai.hyundai-europe.com/';

const cryptSaltKey = 'XeCCQcIzySskw0SQcqfj';
const secondSaltKey = 'E1iL02mFmck25GalMHD5';
// 'http://socket.wondermove.kr/viva';

//! external api key
const GOOGLE_API_KEY = 'AIzaSyAtC5y3_EnD9I8bu7rXnKyNADcLd_phVkk';
  ...
  switch (appEnv) {
    case 'local':
      return {
        appEnv,
        appType,
        wsConnectionInterval,
        appName,
        server_url: `http://${devServer}`,
        wsUrl: `ws://${devServer}`,
        baseUrl: `http://${devServer}/api/v1`,
      };
    case 'dev':
      return {
        appEnv,
        ...
        sentryDSN,
        rdEnv: rdDev,
        webRTCServer: webRTCDevServer,
        webRTCUri: webRTCDevUri,
        webRTCPath: webRTCDevPath,
        webRTCPort: webRTCDevPort,
        cryptSaltKey,
        secondSaltKey,
      };
    case 'stage':
      return {
        ...
        appName,
        // server_url: `http://${devServer}`,
        wsUrl: stageWebSocket,
        baseUrl: stageServer,
        domImageServer,
        sentrySampleRate,
        sentryEnv: sentryStage,
        sentryDSN,
        rdEnv: rdDev,
        webRTCServer: webRTCDevServer,
        webRTCUri: webRTCProdUri,
        webRTCPath: webRTCDevPath,
        webRTCPort: webRTCDevPort,
        cryptSaltKey,
        secondSaltKey,
    ...
    case 'production':
      return {
        ...
        sentryDSN,
        sentrySampleRate,
        sentryEnv: sentryProd,
        rdEnv: rdProd,
        webRTCServer: webRTCProdServer,
        webRTCUri: webRTCProdUri,
        webRTCPath: webRTCProdPath,
        webRTCPort: webRTCProdPort,
        cryptSaltKey,
        secondSaltKey,
      };
    default:
...
const changeToDev = () => (appEnv = 'dev');
const changeToStage = () => (appEnv = 'stage');
const changeToProd = () => (appEnv = 'production');
...
const webRTCIceServers = [
  ...
  { urls: ['turn:20.56.33.118:3478'], username: 'turnuser', credential: 'Wonder9595', credentialType: 'password' },
  { urls: ['turn:webrtcwondermove.germanywestcentral.cloudapp.azure.com:443?transport=tcp'], username: 'turnuser', credential: 'Wonder9595', credentialType: 'password' },
  { urls: ['turn:20.39.188.117:3478'], username: 'turnuser', credential: 'Wonder9595', credentialType: 'password' },
];
